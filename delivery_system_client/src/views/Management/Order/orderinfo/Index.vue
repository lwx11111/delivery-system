          ...
          <div
            ...
            <el-form
              ...
              <el-form-item label="打包费">
                <el-input
                        placeholder="请输入打包费"
                      v-model="data.formList.packingCharges"
                      style="width: 200px"
                      @keyup.enter.native="getData">
                </el-input>
              </el-form-item>
              ...
              <el-form-item label="总金额">
                <el-input
                        placeholder="请输入总金额"
                      v-model="data.formList.totalCharge"
                      style="width: 200px"
                      @keyup.enter.native="getData">
                </el-input>
              </el-form-item>
              <el-form-item label="期望时间">
                <el-input
                        placeholder="请输入期望时间"
                      v-model="data.formList.expectedTime"
                      style="width: 200px"
                      @keyup.enter.native="getData">
                </el-input>
              </el-form-item>
              ...
              <el-form-item label="配送服务">
                <el-input
                        placeholder="请输入配送服务"
                      v-model="data.formList.deliveryService"
                      style="width: 200px"
                      @keyup.enter.native="getData">
                </el-input>
              </el-form-item>
              <el-form-item label="下单时间">
                <el-input
                        placeholder="请输入下单时间"
                      v-model="data.formList.orderTime"
                      style="width: 200px"
                      @keyup.enter.native="getData">
                </el-input>
              </el-form-item>
              ...
              <el-form-item label="支付方式">
                <el-input
                        placeholder="请输入支付方式"
                      v-model="data.formList.paymentMethod"
                      style="width: 200px"
                      @keyup.enter.native="getData">
                </el-input>
              </el-form-item>
              ...
              <el-form-item label="餐具数量">
                <el-input
                        placeholder="请输入餐具数量"
                      v-model="data.formList.tableware"
                      style="width: 200px"
                      @keyup.enter.native="getData">
                </el-input>
              </el-form-item>
...
<script lang="ts" setup>
    ...
    const data = reactive({
        ...
        detailUrl: '/name/orderinfo/item', // detailUrl:详情页面地址
