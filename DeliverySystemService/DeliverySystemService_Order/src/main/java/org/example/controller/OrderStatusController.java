...
public class OrderStatusController {
    ...
    @PostMapping
    @ResponseBody
    @Operation(description = "创建点单状态流程表")
    public SimpleResponse save(@RequestBody OrderStatusDomain obj){
    ...
    @PutMapping("/{id}")
    @ResponseBody
    @Operation(description = "更新点单状态流程表")
    public SimpleResponse update(@PathVariable(name = "id") String id,@RequestBody OrderStatusDomain obj){
        SimpleResponse response = new SimpleResponse();
        try {
    ...
    @DeleteMapping("/{id}")
    @ResponseBody
    @Operation(description = "按ID删除点单状态流程表")
    ...
    @GetMapping("/{id}")
    @Operation(description = "按ID查询点单状态流程表")
    @ResponseBody
    ...
    @PostMapping("/dels")
    @ResponseBody
    @Operation(description = "按ID删除多个点单状态流程表")
    ...
    @PostMapping("/delby")
    @Operation(description = "条件删除点单状态流程表")
    ...
    @PostMapping("/selby")
    @ResponseBody
    public List<OrderStatusDomain> selectBy(@RequestBody(required = false) Map<String, String> params) {
        return  service.selectBy(params);
    }

    @PostMapping("/selpage")
    @Operation(description = "分页查询点单状态流程表")
    @ResponseBody
    public SimpleResponse selectPage(@RequestBody Map<String, String> params) {
        SimpleResponse response = new SimpleResponse();
        try {
            IPage<OrderStatusDomain> page = service.selectPage(params);
    ...
    @ResponseBody
    public IPage<OrderStatusDomain> selpageCustomSqlByWrapper(@RequestBody Map<String, String> params) {
        return service.selpageCustomSqlByWrapper(params);
    }

    @PostMapping("/selpageCustomSqlByMap")
    @Operation(description = "分页查询-自定义sql-Map点单状态流程表")
    @ResponseBody
    public IPage<OrderStatusDomain> selpageCustomSqlByMap(@RequestBody Map<String, String> params) {
