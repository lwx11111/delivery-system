...
public class ShopCommentController {
    @Autowired
    private IShopCommentService service;

    @PostMapping
    @Operation(description = "创建")
    void save(@RequestBody ShopComment obj){
       service.saveByParam(obj,obj.getParams());
    }

    @PutMapping("/{id}")
    @Operation(description = "更新")
    void update(@PathVariable(name = "id") Integer id,@RequestBody ShopComment obj){
    ...
    @ResponseBody
    ShopComment select(@PathVariable(name = "id") Integer id) {
       ShopComment obj = service.getById(id);
       return obj;
    }
    ...
    @PostMapping("/selby")
    @ResponseBody
    List<ShopComment> selectBy(@RequestBody(required = false) Map<String, String> params) {
    ...
    @ResponseBody
    IPage<ShopComment> selectPage(@RequestBody Map<String, String> params) {
        return service.selectPage(params);
    }

    @PostMapping("/selpageCustomSqlByWrapper")
    @ResponseBody
    IPage<ShopComment> selpageCustomSqlByWrapper(@RequestBody Map<String, String> params) {
    ...
    @ResponseBody
    IPage<ShopComment> selpageCustomSqlByMap(@RequestBody Map<String, String> params) {
